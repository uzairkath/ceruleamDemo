...
describe("nfts", function () {
  ...
  .withArgs(constants.ZERO_ADDRESS, owner.address, 1);
   console.log(await firstNFT.balanceOf(owner.address)); 
  });
  ...
  it("Should mint the token of second contract in taking first token", async function () {
    ...
    console.log('beforeBalance nft2 is ', balanceBefore)
    ...
    console.log('beforeBalance nft1 is ', balanceBefore1)
    ...
    console.log('beforeAfter nft2 is ', balanceAfter);
    ...
    console.log('beforeAfter nft1 is ', balanceAfter1);
    ...
    console.log(await secondNFT.ownerOf(0));
    ...
    it("Should swap the token of second contract with the token of first contract", async function () {
      ...
      const balanceAfter = await secondNFT.balanceOf(owner.address);
      console.log('balanceAfter nft2 is ', balanceAfter);
      const balanceAfter1 = await firstNFT.balanceOf(owner.address);
      console.log('balanceAfter nft1 is ', balanceAfter1);
